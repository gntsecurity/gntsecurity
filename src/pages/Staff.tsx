  ...
  return (
    div className=max-w-4xl mx-auto px-4 py-20 space-y-10
      section className=space-y-4
        motion.h1
          className=text-4xl mdtext-5xl font-bold
      ...
      section className=bg-white border rounded-2xl shadow-sm p-6 space-y-4
        ...
        a
          href=httpsgntsecurity.rmmservices.netauth#login
          target=_blank
          rel=noreferrer
          className=inline-flex items-center gap-2 px-5 py-3 rounded-lg bg-blue-600 text-white font-semibold hoverbg-blue-700 transition
